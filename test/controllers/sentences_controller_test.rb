...
class SentencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sentence" do
    assert_difference("Sentence.count") do
      post sentences_url, params: { sentence: { content: @sentence.content, mypic_id: @sentence.mypic_id } }
    end
  ...
  test "should update sentence" do
    patch sentence_url(@sentence), params: { sentence: { content: @sentence.content, mypic_id: @sentence.mypic_id } }
